...
export default function Industrial() {
  ...
  const industries = [
    { title: t("industryNewsTitle"), desc: t("industryNewsDesc") },
    { title: t("industryNewsTitle"), desc: t("industryNewsDesc") },
    { title: t("industryNewsTitle"), desc: t("industryNewsDesc") },
    { title: t("industryNewsTitle"), desc: t("industryNewsDesc") },
    { title: t("industryNewsTitle"), desc: t("industryNewsDesc") },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {industries.map((item, i) => (
          ...
          >
            ...
            <div>
              <h3 className="font-medium text-sm transition-colors duration-300 text-title-color hover:text-title-color/80">
                {item.title}
              </h3>
